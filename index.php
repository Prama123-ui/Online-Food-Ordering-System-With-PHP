...
<a href="Admin/login.php"><button type="button" class="btn btn-warning">Admin</button></a>
</div>
...
<div class="container pt-5">
  <div class="row ">
    ...
    <div class="col-lg-4 col-md-4 col-12">
    <div>
    <h5 class="fas fa-phone text-white">&nbsp;&nbsp;+977 9856565004</h5><br>
    <h4 class="fa fa-envelope text-white">&nbsp;&nbsp;panditprama1@gmail.com</h4><br><br>
    </div>
    </div>
...
<div class=" text-center text-white bg-secondary p-2 "><p>Copyright &copy;2021 All rights reserverd | Designed by Prama Pandit. </p></div>
</footer>
